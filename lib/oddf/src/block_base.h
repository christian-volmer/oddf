...
public:
	...
	*/
	...
	virtual std::unique_ptr<oddf::IListView<oddf::design::blocks::backend::IDesignBlockInput const &>> GetInputsList() const override;
	virtual std::unique_ptr<oddf::IListView<oddf::design::blocks::backend::IDesignBlockOutput const &>> GetOutputsList() const override;
};
